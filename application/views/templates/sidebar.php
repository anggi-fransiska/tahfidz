  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4" style="background-color: #172a3a;">
    ...
    <a href="#" class="brand-link" style="background-color: #172a3a;">
      <img src="<?= base_url('assets/'); ?>img/tahfidz.png" alt="AdminLTE Logo" class="brand-image img-circle ">
      <span class="brand-text font-weight-bold" style="color: white;">Tahfidz</span>
    </a>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url('halaqoh/jadwal'); ?>" class="nav-link <?= $subUrl == "jadwal" ? 'active bg-primary' : ''; ?>">
                  ...
                  <p style="color: white;">Waktu Hafalan</p>
                </a>
              </li>
              <!-- Detail Kelompok -->
              <!-- <li class="nav-item">
