...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="card" style="width: 25rem;">
      <div class="card-body login-card-body" style="background: linear-gradient(to right, #56ab2f, #a8e063); color: white;">
        <div class="row">
          <table>
            <tr>
              <td>
                <img src="<?= base_url('assets/img/tahfidz.png'); ?>" width="140px">
              </td>
              <td>
                <p class="ml-2" style="text-align: left; font-size: 20px;">APLIKASI<br> TAHFIDZ ALQUR'AN</p>
              </td>
            </tr>
          </table>
        </div>
